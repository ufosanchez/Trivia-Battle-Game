...
//        background()
    ...
    func monster(){
        let scene = SCNScene(named: "3D_Game.scn")!
        dragon = scene.rootNode.childNode(withName: "dragon", recursively: true)!
        rootNode.addChildNode(dragon)
    }
    
    func warrior(){
        let scene = SCNScene(named: "3D_Game.scn")!
        let warrior = scene.rootNode.childNode(withName: "warrior", recursively: true)!
        rootNode.addChildNode(warrior)
    }
    
    func background(){
        let scene = SCNScene(named: "3D_Game.scn")!
        let background = scene.rootNode.childNode(withName: "background", recursively: true)!
        rootNode.addChildNode(background)
    }
